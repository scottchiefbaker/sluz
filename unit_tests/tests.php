...
sluz_test('{$y|join_comma:","}'                    , '2,4,6'      , 'Basic #39 - Function with string param pipe comma');
sluz_test('{$y|join_comma:"\'"}'                   , "2'4'6"      , 'Basic #39 - Function with string param pipe single quote');
